/**
 * @class ObsiaDesignSearchBar
 * @augments HTMLElement
 * @description Web component for the design search bar on the design page.
 */
class ObsiaDesignSearchBar extends HTMLElement {
  searchInput = null;
  clearButton = null;

  /**
   * @description Constructs the ObsiaDesignSearchBar instance.
   * @returns {void}
   */
  constructor() {
    super();
    ...
    this.innerHTML = `
            <img src="/wp-content/plugins/obsia/assets/icons/menu.svg" class="h-5 w-5 cursor-pointer" />
            ...
            <img src="/wp-content/plugins/obsia/assets/icons/x.svg" id="clearSearchButton" class="h-5 w-5 hidden cursor-pointer h-full" />
        `;
  }
...
customElements.define("obsia-design-search-bar", ObsiaDesignSearchBar);
