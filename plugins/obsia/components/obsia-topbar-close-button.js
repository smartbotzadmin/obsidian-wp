...
class ObsiaTopbarCloseButton extends HTMLElement {
  ...
  /**
   * @description Constructs the ObsiaTopBarCloseButton instance.
   * @returns {void}
   */
  constructor() {
    super();
    ...
    this.innerHTML = /*html*/ `
			...
			<div id="crossButton" class="relative flex justify-center items-center size-10 bg-gray-800 hover:bg-gray-900 rounded-full transition-all cursor-pointer">
				<div class="focus:outline-none cursor-pointer">
					<img
						src="${obsia_vars.plugin_url}assets/icons/x.svg"
						alt="Close"
					/>
				</div>
			</div>
...
customElements.define("obsia-topbar-close-button", ObsiaTopbarCloseButton);
