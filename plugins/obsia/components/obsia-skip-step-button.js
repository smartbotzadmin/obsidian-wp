...
class ObsiaSkipStepButton extends HTMLElement {
  ...
  /**
   * @description Constructs the ObsiaSkipStepButton instance.
   * @returns {void}
   */
  constructor() {
    super();
...
customElements.define("obsia-skip-step-button", ObsiaSkipStepButton);
