/**
 * @class ObsiaPlanSelector
 * @augments HTMLElement
 * @description Web component for displaying subscription plans in a modal.
 */
class ObsiaPlanSelector extends HTMLElement {
  /**
   * @description Constructs the ObsiaPlanSelector instance.
   * @returns {void}
   */
  constructor() {
    super();
...
customElements.define("obsia-plan-selector", ObsiaPlanSelector);
