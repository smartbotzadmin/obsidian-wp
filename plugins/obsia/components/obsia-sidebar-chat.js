 ...
 */
class ObsiaSidebarChat extends HTMLElement {
  /**
   * @description Constructs the ObsiaSidebarChat instance.
   * @returns {void}
   */
  constructor() {
    super();
    this.innerHTML = `
            <div class="h-full overflow-y-auto p-2 bg-slate-950">
                <div class="flex flex-col items-center justify-center h-full text-center text-white">
                    <img src="${window.location.origin}/wp-content/plugins/obsia/assets/icons/wand-sparkles-dark.svg" alt="Sparkles" class="h-12 w-12 mb-4" />
...
customElements.define("obsia-sidebar-chat", ObsiaSidebarChat);
