        ...
        this.innerHTML = `
            <div class="relative flex justify-center items-center mb-6">
                <div class="relative min-w-96">
                    <input type="text" id="designSearchInput" class="shadow appearance-none border border-gray-300 rounded-lg w-full h-11 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline pl-10" placeholder="agency, consultant, web designer">
