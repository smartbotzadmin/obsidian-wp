  ...
  constructor() {
    ...
    this.innerHTML = /*html*/ `
            <div class="relative grow flex items-center justify-center bg-slate-900 text-slate-100 overflow-hidden">
                <img
                    id="loadingOption"
                    src="${owp_vars.plugin_url}assets/icons/image.svg"
                    alt="Image Icon"
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="#" class="text-slate-100 hover:text-slate-300 hover:opacity-75">
                            <img src="${owp_vars.plugin_url}assets/icons/external-link.svg" alt="External Link Icon" class="w-5 h-5">
                        </a>
                        <a href="#" class="text-slate-100 hover:text-slate-300 hover:opacity-75">
                            <img src="${owp_vars.plugin_url}assets/icons/info.svg" alt="Info Icon" class="w-5 h-5">
                        </a>
                    </div>
                </div>
            </div>
