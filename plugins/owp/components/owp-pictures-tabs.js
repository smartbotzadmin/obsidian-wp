    ...
    constructor() {
        ...
        this.innerHTML = `
            <div class="flex border-b border-gray-200 mb-6">
                <button class="tab-button px-4 py-2 text-sm font-medium text-purple-600 border-b-2 border-purple-600 focus:outline-none" data-tab="search-results">Search Results</button>
                <button class="tab-button px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-none" data-tab="upload-images">Upload Your Images</button>
                <button class="tab-button px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-none" data-tab="selected-images">Selected Images</button>
                <div class="flex-grow"></div>
                <div class="relative">
                    <select class="block appearance-none w-full bg-white border border-gray-300 text-gray-700 py-2 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-11">
