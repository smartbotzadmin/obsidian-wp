/**
 * @class OwpTopbarStripeButton
 * @augments HTMLElement
 * @description Web component for checking Stripe subscription status and providing a subscribe button.
 */
class OwpTopbarStripeButton extends HTMLElement {
  boundHandleHashChange = null;
  /**
   * @description Constructs the OwpTopbarStripeButton instance.
   * @returns {void}
   */
  constructor() {
    super();
...
customElements.define("owp-topbar-stripe-button", OwpTopbarStripeButton);
