...
class OwpContactSocialMedia extends HTMLElement {
  ...
  constructor() {
    ...
    this.innerHTML = /*html*/ `
			<label for="socialMedia" class="flex flex-row items-center gap-1 text-slate-300 text-sm font-semibold mb-2 cursor-default">
				Social Media
				<img class=\"ml-1\" src=\"${owp_vars.plugin_url}assets/icons/info.svg\" alt=\"info icon\">
			</label>
  ...
  #addSocialField(event, initialValue = "") {
    ...
    iconImg.src = `${owp_vars.plugin_url}assets/icons/social/${socialName}.svg`;
    ...
    trashImg.src = `${owp_vars.plugin_url}assets/icons/trash.svg`;
