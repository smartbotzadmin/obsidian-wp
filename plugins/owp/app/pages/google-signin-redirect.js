/**
 * @class OwpGoogleSigninRedirect
 * @augments HTMLElement
 * @description Web component to handle the Google Sign-in redirect.
 */
class OwpGoogleSigninRedirect extends HTMLElement {
  /**
   * @description Constructs the OwpGoogleSigninRedirect instance.
   * @returns {void}
   */
  constructor() {
    super();
...
customElements.define("owp-google-signin-redirect", OwpGoogleSigninRedirect);
